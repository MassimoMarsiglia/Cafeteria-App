...
export function BurgerMenu({ visible, onClose, currentRoute }: BurgerMenuProps) {
      ...
      >
        <SafeAreaView style={styles.safeArea}>
          <ThemedView style={[
            ...
            {/* Header */}
            <ThemedView style={[styles.menuHeader, { borderBottomColor: Colors[colorScheme ?? 'light'].tint + '20' }]}>
              <ThemedText type="title" style={styles.menuTitle}>Navigation</ThemedText>
              ...
              {menuItems.map((item) => {
                ...
                return (
                  <TouchableOpacity
                    ...
                    style={[
                      styles.menuItem,
                      isActive && { backgroundColor: Colors[colorScheme ?? 'light'].tint + '10' }
                    ]}
                      ...
                      <ThemedView style={styles.textContainer}>
                        <ThemedText 
                          style={[
                            ...
                            isActive && { color: Colors[colorScheme ?? 'light'].tint, fontWeight: 'bold' }
                          ]}
                        >
                          {item.title}
                        </ThemedText>
            ...
            {/* Footer */}
            <ThemedView style={[styles.menuFooter, { borderTopColor: Colors[colorScheme ?? 'light'].tint + '20' }]}>
