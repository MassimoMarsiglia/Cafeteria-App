    ...
    useEffect(() => {
        if (canteens && canteens.length > 0 && !selectedCanteenId) {
            ...
            console.log(
                'HTW Canteen found:',
                htwCanteen
                    ? { ID: htwCanteen.ID, name: htwCanteen.name }
                    : 'Not found',
            );
            const targetCanteenId = htwCanteen
                ? htwCanteen.ID
                : canteens[0]?.ID;
        ...
        >
            ...
            >
                ...
                {__DEV__ && (
                    ...
                    >
                        Debug: Canteen ID: {selectedCanteenId || 'none'} | Menu
                        items: {todaysMenu?.length || 0} | Total meals:{' '}
                        {allMeals.length}
                    </ThemedText>
                )}
