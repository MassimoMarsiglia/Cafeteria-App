    ...
    return (
        ...
        >
            <AppHeader
                ...
                subtitle={
                    canteens
                        ? `${canteens.length} Mensen gefunden`
                        : 'Lade Mensen...'
                }
            />
            <ScrollView
                            ...
                            >
                                <ThemedView style={styles.canteenHeader}>
                                    ...
                                    <ThemedView style={styles.canteenInfo}>
                                        <ThemedText
                                            type="subtitle"
                                            style={styles.canteenName}
                                        >
                                            {canteen.name}
                                        </ThemedText>
                                        {canteen.address && (
                                            <ThemedText
                                                style={styles.canteenAddress}
                                            >
                                                {[
                                                    canteen.address.street,
                                                    [
                                                        canteen.address.zipcode,
                                ...
                                {canteen.address?.geolocation && (
                                    ...
                                    >
                                        ...
                                        <ThemedText style={styles.locationText}>
                                            {canteen.address.geolocation.latitude.toFixed(
                                                4,
                                            )}
                                            ,{' '}
                                            {canteen.address.geolocation.longitude.toFixed(
                                                4,
                                            )}
                                        </ThemedText>
                                    </ThemedView>
